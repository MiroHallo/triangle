function [mClass, dP, dT, dB] = mech_class(strike, dip, rake)
% MECH_CLASS Returns Classification of source focal mechanisms by PTB-axes.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% Classification of source focal mechanisms by PTB-axes
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% 
% OUTPUT:
% mClass - flag of the mechanism, 0:odd, 1:strike-slip, 2:normal, 3:reverse
% dP, dT, dB - dip angles from horizontal of P, T and B axis respectively
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:N
    ...
    if sind(dB(i))^2 > 0.75 % Strike-slip (Threshold based on Frohlich 1992)
        mClass(i) = 1;
    elseif sind(dP(i))^2 > 0.75 % Normal (Threshold based on Frohlich 1992)
        mClass(i) = 2;
    elseif sind(dT(i))^2 > 0.59 % Reverse (Threshold based on Frohlich 1992)
        mClass(i) = 3;
    else % Odd
        mClass(i) = 0;
    end
