...
Tools suite for double-couple seismic source analysis: Plot focal mechanism PT-axes into polar diagram, triangle diagram, and polar histograms of strike azimuths and dip angles. The software is [citable](#9-cite-as) and archived on Zenodo.
